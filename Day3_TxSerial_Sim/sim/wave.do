...
add wave -noupdate /tbtxserial/TT
...
add wave -noupdate -radix decimal /tbtxserial/u_TxSerial/rBuadCnt
add wave -noupdate /tbtxserial/u_TxSerial/rBuadEnd
add wave -noupdate -radix binary /tbtxserial/u_TxSerial/rSerData
add wave -noupdate -radix unsigned /tbtxserial/u_TxSerial/rDataCnt
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {38551400 ps} 0}
...
update
WaveRestoreZoom {0 ps} {40999100 ps}
